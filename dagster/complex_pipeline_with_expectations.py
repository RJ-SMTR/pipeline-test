...
import os
import csv
from dagster import solid, pipeline, Output
from custom_types import ReadSimpleDataFrame, expect_column_to_be_integers
...
def sort_by_calories(_, cereals:ReadSimpleDataFrame):
    ...
    yield Output((least_caloric, most_caloric))
