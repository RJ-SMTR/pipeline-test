...
from custom_types import SimpleDataFrame, LessSimpleDataFrame

@solid
def load_cereals(_, csv_path:str) -> LessSimpleDataFrame:
...
@solid
def sort_by_calories(_, cereals:SimpleDataFrame):
    sorted_cereals = list(
